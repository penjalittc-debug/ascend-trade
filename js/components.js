  ...
  function header(active){
    ...
    <header class="header" data-dark>
      <div class="container header-inner">
        ...
        <div class="nav-right">
          <div class="lang">
            <button class="lang-btn"><span class="lang-cur">🇦🇿 AZ</span> ${ICON.chevron}</button>
      ...
      <div class="container">
        <div class="footer-top">
          ...
          <div>
            ...
            <ul class="f-contact">
              <li>${ICON.phone}<a href="tel:+994000000000">+994 00 000 00 00</a></li>
              <li>${ICON.mail}<a href="mailto:info@ascendtrade.az">info@ascendtrade.az</a></li>
